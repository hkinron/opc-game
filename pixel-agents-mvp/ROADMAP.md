...
### Agent 互动系统 (`InteractionSystem.ts`)
- 15 组真实对话（PR/bug/咖啡/部署等程序员日常）
- 距离检测（2.5 格以内），互相面对
- 30 秒冷却

### 物品互动
- 5 个物品：咖啡机 ☕、沙发 🛋️、白板 📝、书架 📚、打印机 🖨️
- 悬浮高亮（黄色虚线框），点击派遣最近空闲 agent
- 独立动作文本和持续时间，用完后 50% 回工位

### 构建: 18 模块 → 46.3KB (gzip 14.6KB)
